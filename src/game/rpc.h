...
/*
 *    Returns if the relationship is a friend and the user is less cool than the application.
 *    ... ok copilot...
 ...
 *    @param struct DiscordRelationship *    The relationship.
 * 
 *    @return u32                            1 if the relationship is a friend and the user is less cool than the application, 0 otherwise.
 */
